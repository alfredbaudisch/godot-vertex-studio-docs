...
Vertex Studio is a Godot plugin for **editing, managing and painting vertex colors and vertex normals** of 3D meshes. It's a complete solution for vertex painting inside the Godot editor. It has tools for:
